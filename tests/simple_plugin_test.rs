...
fn test_plugin_builds_successfully() {
    ...
    let plugin_dir = PathBuf::from(env!("CARGO_MANIFEST_DIR")).join("plugins/hello");
...
fn test_template_plugin_builds() {
    ...
    let template_dir = PathBuf::from(env!("CARGO_MANIFEST_DIR")).join("plugins/template");
...
fn test_plugin_sdk_compiles() {
    ...
    let sdk_dir = PathBuf::from(env!("CARGO_MANIFEST_DIR")).join("plugin-sdk");
